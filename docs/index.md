...
| 课程 | 时间 | 描述 | 进度 |
|------|------|------|------|
| [Agents](agents/index.md) | 周一、周五 | LLM agents, reasoning, tools, planning, RL-for-agents | 🟢 Active — Memory (1d, 3 papers, conf 0.35) / ✅ Planning (5d, 15 papers, conf 0.80) / ✅ Tool Use (5d, 15 papers, conf 0.82) / ✅ Architectures (5d, 15 papers, conf 0.85) |
| [Multimodal, VLA & Robotics](multimodal/index.md) | 周二 | VLM, video, grounding, VLA, world models | 🟢 Active — Image-Text Reasoning (3d, 9 papers, conf 0.62) / ✅ VLM Pretraining (5d, 13 papers, conf 0.82) |
